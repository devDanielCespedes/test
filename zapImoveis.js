...
const zapImoveisWebPagesDir = path.join(__dirname, "zapImoveisWebPages");
if (!fs.existsSync(zapImoveisWebPagesDir)) {
  fs.mkdirSync(zapImoveisWebPagesDir);
}
